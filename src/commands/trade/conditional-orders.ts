					...
					return TRADE_COMMAND_EXECUTOR.execute(
						{
							...
							critical: {
								...
								expireDate: params.expireDate,
								firstOrderPrice: params.firstOrderPrice,
								firstOrderSide: params.firstOrderSide,
								firstTriggerPrice: params.firstTriggerPrice,
								orderType: params.orderType,
								quantity: params.quantity,
								secondOrderPrice: params.secondOrderPrice,
								secondOrderSide: params.secondOrderSide,
								secondTriggerPrice: params.secondTriggerPrice,
								symbol: params.symbol,
								type: params.type,
							},
							live: params.live,
